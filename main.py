...
ax4.scatter(data2["EBITDA"], data2["Dividend Yield"])
ax4.set_title('Relationship between EBITDA and Dividend Yield in S&P 500')
ax4.set_xlabel('EBITDA')
ax4.set_ylabel('Dividend Yield')
plt.show()
data2_EBITDA = data2.groupby("Sector")["EBITDA"].mean()\
    .reset_index(name="Average EBITDA")
data2_EBITDA = data2_EBITDA.set_index("Sector")
print(data2_EBITDA.head(10))
fig5,ax5 = plt.subplots()
ax5.bar(data2_EBITDA.index, data2_EBITDA["Average EBITDA"])
ax5.set_xticklabels(data2_EBITDA.index, rotation=90)
ax5.set_ylabel("Average EBITDA")
ax5.set_title('Average EBITDA by Sector')
plt.tight_layout()
plt.show()
